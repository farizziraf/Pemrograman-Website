                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <select name="jenis_pendaftaran" class="form-control <?php echo ($error_jenis_pendaftaran != "" ? "is-invalid" : ""); ?>" id="jenis_pendaftaran">
                                        ...
                                        <option value="Siswa Baru" <?php if ($jenis_pendaftaran == "Siswa Baru")
                                            echo "selected"; ?>>Siswa Baru</option>
                                        <option value="Pindahan" <?php if ($jenis_pendaftaran == "Pindahan")
                                            echo "selected"; ?>>Pindahan</option>
                                    </select>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-4 d-flex justify-content-around">
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="pernah_paud" id="pernah_paud_ya" value="Ya" <?php if ($pernah_paud == "Ya")
                                            echo "checked"; ?>>
                                        <label class="form-check-label" for="pernah_paud_ya">Ya</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="pernah_paud" id="pernah_paud_tidak" value="Tidak" <?php if ($pernah_paud == "Tidak")
                                            echo "checked"; ?>>
                                ...
                                <div class="col-sm-4 d-flex justify-content-around">
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="pernah_tk" id="pernah_tk_ya" value="Ya" <?php if ($pernah_tk == "Ya")
                                            echo "checked"; ?>>
                                        <label class="form-check-label" for="pernah_tk_ya">Ya</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="pernah_tk" id="pernah_tk_tidak" value="Tidak" <?php if ($pernah_tk == "Tidak")
                                            echo "checked"; ?>>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <select name="hobi" class="form-control <?php echo ($error_hobi != "" ? "is-invalid" : ""); ?>" id="hobi">
                                        ...
                                        <option value="Olahraga" <?php if ($hobi == "Olahraga")
                                            echo "selected"; ?>>Olahraga</option>
                                        <option value="Kesenian" <?php if ($hobi == "Kesenian")
                                            echo "selected"; ?>>Kesenian</option>
                                        <option value="Membaca" <?php if ($hobi == "Membaca")
                                            echo "selected"; ?>>Membaca</option>
                                        <option value="Menulis" <?php if ($hobi == "Menulis")
                                            echo "selected"; ?>>Menulis</option>
                                        <option value="Traveling" <?php if ($hobi == "Traveling")
                                            echo "selected"; ?>>Traveling</option>
                                        <option value="Lainnya" <?php if ($hobi == "Lainnya")
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <select name="cita_cita" class="form-control <?php echo ($error_cita_cita != "" ? "is-invalid" : ""); ?>" id="cita_cita">
                                        ...
                                        <option value="PNS" <?php if ($cita_cita == "PNS")
                                            echo "selected"; ?>>PNS</option>
                                        <option value="TNI/POLRI" <?php if ($cita_cita == "TNI/POLRI")
                                            echo "selected"; ?>>TNI/POLRI</option>
                                        <option value="Guru/Dosen" <?php if ($cita_cita == "Guru/Dosen")
                                            echo "selected"; ?>>Guru/Dosen</option>
                                        <option value="Dokter" <?php if ($cita_cita == "Dokter")
                                            echo "selected"; ?>>Dokter</option>
                                        <option value="Politikus" <?php if ($cita_cita == "Politikus")
                                            echo "selected"; ?>>Politikus</option>
                                        <option value="Wiraswasta" <?php if ($cita_cita == "Wiraswasta")
                                            echo "selected"; ?>>Wiraswasta</option>
                                        <option value="Seni/Lukis/Artis/Sejenis" <?php if ($cita_cita == "Seni/Lukis/Artis/Sejenis")
                                            echo "selected"; ?>>Seni/Lukis/Artis/Sejenis</option>
                                        <option value="Lainnya" <?php if ($cita_cita == "Lainnya")
                                            echo "selected"; ?>>Lainnya</option>
                                    </select>
                                </div>
                            </div>
                        ...
                        <fieldset id="fieldset2" style="display: none">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <select name="berkebutuhan_khusus" class="form-control <?php echo ($error_berkebutuhan_khusus != "" ? "is-invalid" : ""); ?>" id="berkebutuhan_khusus">
                                        <option value="Tidak" <?php if ($berkebutuhan_khusus == "Tidak")
                                            echo "selected"; ?>>Tidak</option>
                                        <option value="Netra" <?php if ($berkebutuhan_khusus == "Netra")
                                            echo "selected"; ?>>Netra</option>
                                        <option value="Rungu" <?php if ($berkebutuhan_khusus == "Rungu")
                                            echo "selected"; ?>>Rungu</option>
                                        <option value="Grahita Ringan" <?php if ($berkebutuhan_khusus == "Grahita Ringan")
                                            echo "selected"; ?>>Grahita Ringan</option>
                                        <option value="Grahita Sedang" <?php if ($berkebutuhan_khusus == "Grahita Sedang")
                                            echo "selected"; ?>>Grahita Sedang</option>
                                        <option value="Daksa Ringan" <?php if ($berkebutuhan_khusus == "Daksa Ringan")
                                            echo "selected"; ?>>Daksa Ringan</option>
                                        <option value="Daksa Sedang" <?php if ($berkebutuhan_khusus == "Daksa Sedang")
                                            echo "selected"; ?>>Daksa Sedang</option>
                                        <option value="Laras" <?php if ($berkebutuhan_khusus == "Laras")
                                            echo "selected"; ?>>Laras</option>
                                        <option value="Wicara" <?php if ($berkebutuhan_khusus == "Wicara")
                                            echo "selected"; ?>>Wicara</option>
                                        <option value="Tuna Ganda" <?php if ($berkebutuhan_khusus == "Tuna Ganda")
                                            echo "selected"; ?>>Tuna Ganda</option>
                                        <option value="Hiper Aktif" <?php if ($berkebutuhan_khusus == "Hiper Aktif")
                                            echo "selected"; ?>>Hiper Aktif</option>
                                        <option value="Cerdas Istimewa" <?php if ($berkebutuhan_khusus == "Cerdas Istimewa")
                                            echo "selected"; ?>>Cerdas Istimewa</option>
                                        <option value="Bakat Istimewa" <?php if ($berkebutuhan_khusus == "Bakat Istimewa")
                                            echo "selected"; ?>>Bakat Istimewa</option>
                                        <option value="Kesulitan Belajar" <?php if ($berkebutuhan_khusus == "Kesulitan Belajar")
                                            echo "selected"; ?>>Kesulitan Belajar</option>
                                        <option value="Narkoba" <?php if ($berkebutuhan_khusus == "Narkoba")
                                            echo "selected"; ?>>Narkoba</option>
                                        <option value="Indigo" <?php if ($berkebutuhan_khusus == "Indigo")
                                            echo "selected"; ?>>Indigo</option>
                                        <option value="Down Sindrome" <?php if ($berkebutuhan_khusus == "Down Sindrome")
                                            echo "selected"; ?>>Down Sindrome</option>
                                        <option value="Autis" <?php if ($berkebutuhan_khusus == "Autis")
                                            echo "selected"; ?>>Autis</option>
                                    </select>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <select name="tempat_tinggal" class="form-control <?php echo ($error_tempat_tinggal != "" ? "is-invalid" : ""); ?>" id="tempat_tinggal">
                                        <option value="Bersama Orang Tua" <?php if ($tempat_tinggal == "Bersama Orang Tua")
                                            echo "selected"; ?>>Bersama Orang Tua</option>
                                        <option value="Wali" <?php if ($tempat_tinggal == "Wali")
                                            echo "selected"; ?>>Wali</option>
                                        <option value="Kos" <?php if ($tempat_tinggal == "Kos")
                                            echo "selected"; ?>>Kos</option>
                                        <option value="Asrama" <?php if ($tempat_tinggal == "Asrama")
                                            echo "selected"; ?>>Asrama</option>
                                        <option value="Panti Asuhan" <?php if ($tempat_tinggal == "Panti Asuhan")
                                            echo "selected"; ?>>Panti Asuhan</option>
                                        <option value="Lainnya" <?php if ($tempat_tinggal == "Lainnya")
                                            echo "selected"; ?>>Lainnya</option>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <select name="transportasi" class="form-control <?php echo ($error_transportasi != "" ? "is-invalid" : ""); ?>" id="transportasi">
                                        <option value="Jalan Kaki" <?php if ($transportasi == "Jalan Kaki")
                                            echo "selected"; ?>>Jalan Kaki</option>
                                        <option value="Kendaraan Pribadi" <?php if ($transportasi == "Kendaraan Pribadi")
                                            echo "selected"; ?>>Kendaraan Pribadi</option>
                                        <option value="Kendaraan Umum" <?php if ($transportasi == "Kendaraan Umum")
                                            echo "selected"; ?>>Kendaraan Umum</option>
                                        <option value="Jemputan Sekolah" <?php if ($transportasi == "Jemputan Sekolah")
                                            echo "selected"; ?>>Jemputan Sekolah</option>
                                        <option value="Kereta Api" <?php if ($transportasi == "Kereta Api")
                                            echo "selected"; ?>>Kereta Api</option>
                                        <option value="Ojek" <?php if ($transportasi == "Ojek")
                                            echo "selected"; ?>>Ojek</option>
                                        <option value="Andong/Bendi/Sado/Dokar/Delman/Beca" <?php if ($transportasi == "Andong/Bendi/Sado/Dokar/Delman/Beca")
                                            echo "selected"; ?>>Andong/Bendi/Sado/Dokar/Delman/Beca</option>
                                        <option value="Perahu Penyebrangan/Rakit/Getek" <?php if ($transportasi == "Perahu Penyebrangan/Rakit/Getek")
                                            echo "selected"; ?>>Perahu Penyebrangan/Rakit/Getek</option>
                                        <option value="Lainnya" <?php if ($transportasi == "Lainnya")
                                            echo "selected"; ?>>Lainnya</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-2 d-flex">
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="penerima_kps" id="penerima_kps_ya" value="Ya" <?php if ($penerima_kps == "Ya")
                                            echo "checked"; ?>>
                                        <label class="form-check-label" for="penerima_kps_ya">Ya</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="penerima_kps" id="penerima_kps_tidak" value="Tidak" <?php if ($penerima_kps == "Tidak")
                                            echo "checked"; ?>>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-4">
                                    <select name="pendidikan_ayah" class="form-control <?php echo ($error_pendidikan_ayah != "" ? "is-invalid" : ""); ?>" id="pendidikan_ayah">
                                        <option value="Tidak Sekolah" <?php if ($pendidikan_ayah == "Tidak Sekolah")
                                            echo "selected"; ?>>Tidak Sekolah</option>
                                        <option value="Putus SD" <?php if ($pendidikan_ayah == "Putus SD")
                                            echo "selected"; ?>>Putus SD</option>
                                        <option value="SD Sederajat" <?php if ($pendidikan_ayah == "SD Sederajat")
                                            echo "selected"; ?>>SD Sederajat</option>
                                        <option value="SMP Sederajat" <?php if ($pendidikan_ayah == "SMP Sederajat")
                                            echo "selected"; ?>>SMP Sederajat</option>
                                        <option value="SMA Sederajat" <?php if ($pendidikan_ayah == "SMA Sederajat")
                                            echo "selected"; ?>>SMA Sederajat</option>
                                        <option value="D1" <?php if ($pendidikan_ayah == "D1")
                                            echo "selected"; ?>>D1</option>
                                        <option value="D2" <?php if ($pendidikan_ayah == "D2")
                                            echo "selected"; ?>>D2</option>
                                        <option value="D3" <?php if ($pendidikan_ayah == "D3")
                                            echo "selected"; ?>>D3</option>
                                        <option value="D4/S1" <?php if ($pendidikan_ayah == "D4/S1")
                                            echo "selected"; ?>>D4/S1</option>
                                        <option value="S2" <?php if ($pendidikan_ayah == "S2")
                                            echo "selected"; ?>>S2</option>
                                        <option value="S3" <?php if ($pendidikan_ayah == "S3")
                                ...
                                <div class="col-sm-4">
                                    <select name="pekerjaan_ayah" class="form-control <?php echo ($error_pekerjaan_ayah != "" ? "is-invalid" : ""); ?>" id="pekerjaan_ayah">
                                        <option value="Tidak Bekerja" <?php if ($pekerjaan_ayah == "Tidak Bekerja")
                                            echo "selected"; ?>>Tidak Bekerja</option>
                                        <option value="Nelayan" <?php if ($pekerjaan_ayah == "Nelayan")
                                            echo "selected"; ?>>Nelayan</option>
                                        <option value="Petani" <?php if ($pekerjaan_ayah == "Petani")
                                            echo "selected"; ?>>Petani</option>
                                        <option value="Peternak" <?php if ($pekerjaan_ayah == "Peternak")
                                            echo "selected"; ?>>Peternak</option>
                                        <option value="PNS/TNI/Polri" <?php if ($pekerjaan_ayah == "PNS/TNI/Polri")
                                            echo "selected"; ?>>PNS/TNI/Polri</option>
                                        <option value="Karyawan Swasta" <?php if ($pekerjaan_ayah == "Karyawan Swasta")
                                            echo "selected"; ?>>Karyawan Swasta</option>
                                        <option value="Pedagang Kecil" <?php if ($pekerjaan_ayah == "Pedagang Kecil")
                                            echo "selected"; ?>>Pedagang Kecil</option>
                                        <option value="Pedagang Besar" <?php if ($pekerjaan_ayah == "Pedagang Besar")
                                            echo "selected"; ?>>Pedagang Besar</option>
                                        <option value="Wiraswasta" <?php if ($pekerjaan_ayah == "Wiraswasta")
                                            echo "selected"; ?>>Wiraswasta</option>
                                        <option value="Wirausaha" <?php if ($pekerjaan_ayah == "Wirausaha")
                                            echo "selected"; ?>>Wirausaha</option>
                                        <option value="Buruh" <?php if ($pekerjaan_ayah == "Buruh")
                                            echo "selected"; ?>>Buruh</option>
                                        <option value="Pensiunan" <?php if ($pekerjaan_ayah == "Pensiunan")
                                            echo "selected"; ?>>Pensiunan</option>
                                        <option value="Lain-lain" <?php if ($pekerjaan_ayah == "Lain-lain")
                                            echo "selected"; ?>>Lain-lain</option>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <select name="penghasilan_ayah" class="form-control <?php echo ($error_penghasilan_ayah != "" ? "is-invalid" : ""); ?>" id="penghasilan_ayah">
                                        <option value="Kurang dari Rp. 500.000" <?php if ($penghasilan_ayah == "Kurang dari Rp. 500.000")
                                            echo "selected"; ?>>Kurang dari Rp. 500.000</option>
                                        <option value="Rp. 500.000 - Rp. 999.999" <?php if ($penghasilan_ayah == "Rp. 500.000 - Rp. 999.999")
                                            echo "selected"; ?>>Rp. 500.000 - Rp. 999.999</option>
                                        <option value="Rp. 1.000.000 - Rp. 1.999.999" <?php if ($penghasilan_ayah == "Rp. 1.000.000 - Rp. 1.999.999")
                                            echo "selected"; ?>>Rp. 1.000.000 - Rp. 1.999.999</option>
                                        <option value="Rp. 2.000.000 - Rp. 4.999.999" <?php if ($penghasilan_ayah == "Rp. 2.000.000 - Rp. 4.999.999")
                                            echo "selected"; ?>>Rp. 2.000.000 - Rp. 4.999.999</option>
                                        <option value="Rp. 5.000.000 - Rp. 19.999.999" <?php if ($penghasilan_ayah == "Rp. 5.000.000 - Rp. 19.999.999")
                                            echo "selected"; ?>>Rp. 5.000.000 - Rp. 19.999.999</option>
                                        <option value="Lebih dari Rp. 20.000.000" <?php if ($penghasilan_ayah == "Lebih dari Rp. 20.000.000")
                                            echo "selected"; ?>>Lebih dari Rp. 20.000.000</option>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <select name="berkebutuhan_khusus_ayah" class="form-control <?php echo ($error_berkebutuhan_khusus_ayah != "" ? "is-invalid" : ""); ?>" id="berkebutuhan_khusus_ayah">
                                        <option value="Tidak" <?php if ($berkebutuhan_khusus_ayah == "Tidak")
                                            echo "selected"; ?>>Tidak</option>
                                        <option value="Netra" <?php if ($berkebutuhan_khusus_ayah == "Netra")
                                            echo "selected"; ?>>Netra</option>
                                        <option value="Rungu" <?php if ($berkebutuhan_khusus_ayah == "Rungu")
                                            echo "selected"; ?>>Rungu</option>
                                        <option value="Grahita Ringan" <?php if ($berkebutuhan_khusus_ayah == "Grahita Ringan")
                                            echo "selected"; ?>>Grahita Ringan</option>
                                        <option value="Grahita Sedang" <?php if ($berkebutuhan_khusus_ayah == "Grahita Sedang")
                                            echo "selected"; ?>>Grahita Sedang</option>
                                        <option value="Daksa Ringan" <?php if ($berkebutuhan_khusus_ayah == "Daksa Ringan")
                                            echo "selected"; ?>>Daksa Ringan</option>
                                        <option value="Daksa Sedang" <?php if ($berkebutuhan_khusus_ayah == "Daksa Sedang")
                                            echo "selected"; ?>>Daksa Sedang</option>
                                        <option value="Laras" <?php if ($berkebutuhan_khusus_ayah == "Laras")
                                            echo "selected"; ?>>Laras</option>
                                        <option value="Wicara" <?php if ($berkebutuhan_khusus_ayah == "Wicara")
                                            echo "selected"; ?>>Wicara</option>
                                        <option value="Tuna Ganda" <?php if ($berkebutuhan_khusus_ayah == "Tuna Ganda")
                                            echo "selected"; ?>>Tuna Ganda</option>
                                        <option value="Hiper Aktif" <?php if ($berkebutuhan_khusus_ayah == "Hiper Aktif")
                                            echo "selected"; ?>>Hiper Aktif</option>
                                        <option value="Cerdas Istimewa" <?php if ($berkebutuhan_khusus_ayah == "Cerdas Istimewa")
                                            echo "selected"; ?>>Cerdas Istimewa</option>
                                        <option value="Bakat Istimewa" <?php if ($berkebutuhan_khusus_ayah == "Bakat Istimewa")
                                            echo "selected"; ?>>Bakat Istimewa</option>
                                        <option value="Kesulitan Belajar" <?php if ($berkebutuhan_khusus_ayah == "Kesulitan Belajar")
                                            echo "selected"; ?>>Kesulitan Belajar</option>
                                        <option value="Narkoba" <?php if ($berkebutuhan_khusus_ayah == "Narkoba")
                                            echo "selected"; ?>>Narkoba</option>
                                        <option value="Indigo" <?php if ($berkebutuhan_khusus_ayah == "Indigo")
                                            echo "selected"; ?>>Indigo</option>
                                        <option value="Down Sindrome" <?php if ($berkebutuhan_khusus_ayah == "Down Sindrome")
                                            echo "selected"; ?>>Down Sindrome</option>
                                        <option value="Autis" <?php if ($berkebutuhan_khusus_ayah == "Autis")
                                            echo "selected"; ?>>Autis</option>
                                    </select>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-4">
                                    <select name="pendidikan_ibu" class="form-control <?php echo ($error_pendidikan_ibu != "" ? "is-invalid" : ""); ?>" id="pendidikan_ibu">
                                        <option value="Tidak Sekolah" <?php if ($pendidikan_ibu == "Tidak Sekolah")
                                            echo "selected"; ?>>Tidak Sekolah</option>
                                        <option value="Putus SD" <?php if ($pendidikan_ibu == "Putus SD")
                                            echo "selected"; ?>>Putus SD</option>
                                        <option value="SD Sederajat" <?php if ($pendidikan_ibu == "SD Sederajat")
                                            echo "selected"; ?>>SD Sederajat</option>
                                        <option value="SMP Sederajat" <?php if ($pendidikan_ibu == "SMP Sederajat")
                                            echo "selected"; ?>>SMP Sederajat</option>
                                        <option value="SMA Sederajat" <?php if ($pendidikan_ibu == "SMA Sederajat")
                                            echo "selected"; ?>>SMA Sederajat</option>
                                        <option value="D1" <?php if ($pendidikan_ibu == "D1")
                                            echo "selected"; ?>>D1</option>
                                        <option value="D2" <?php if ($pendidikan_ibu == "D2")
                                            echo "selected"; ?>>D2</option>
                                        <option value="D3" <?php if ($pendidikan_ibu == "D3")
                                            echo "selected"; ?>>D3</option>
                                        <option value="D4/S1" <?php if ($pendidikan_ibu == "D4/S1")
                                            echo "selected"; ?>>D4/S1</option>
                                        <option value="S2" <?php if ($pendidikan_ibu == "S2")
                                            echo "selected"; ?>>S2</option>
                                        <option value="S3" <?php if ($pendidikan_ibu == "S3")
                                            echo "selected"; ?>>S3</option>
                                    </select>
                                </div>
                                ...
                                <div class="col-sm-4">
                                    <select name="pekerjaan_ibu" class="form-control <?php echo ($error_pekerjaan_ibu != "" ? "is-invalid" : ""); ?>" id="pekerjaan_ibu">
                                        <option value="Tidak Bekerja" <?php if ($pekerjaan_ibu == "Tidak Bekerja")
                                            echo "selected"; ?>>Tidak Bekerja</option>
                                        <option value="Nelayan" <?php if ($pekerjaan_ibu == "Nelayan")
                                            echo "selected"; ?>>Nelayan</option>
                                        <option value="Petani" <?php if ($pekerjaan_ibu == "Petani")
                                            echo "selected"; ?>>Petani</option>
                                        <option value="Peternak" <?php if ($pekerjaan_ibu == "Peternak")
                                            echo "selected"; ?>>Peternak</option>
                                        <option value="PNS/TNI/Polri" <?php if ($pekerjaan_ibu == "PNS/TNI/Polri")
                                            echo "selected"; ?>>PNS/TNI/Polri</option>
                                        <option value="Karyawan Swasta" <?php if ($pekerjaan_ibu == "Karyawan Swasta")
                                            echo "selected"; ?>>Karyawan Swasta</option>
                                        <option value="Pedagang Kecil" <?php if ($pekerjaan_ibu == "Pedagang Kecil")
                                            echo "selected"; ?>>Pedagang Kecil</option>
                                        <option value="Pedagang Besar" <?php if ($pekerjaan_ibu == "Pedagang Besar")
                                            echo "selected"; ?>>Pedagang Besar</option>
                                        <option value="Wiraswasta" <?php if ($pekerjaan_ibu == "Wiraswasta")
                                            echo "selected"; ?>>Wiraswasta</option>
                                        <option value="Wirausaha" <?php if ($pekerjaan_ibu == "Wirausaha")
                                            echo "selected"; ?>>Wirausaha</option>
                                        <option value="Buruh" <?php if ($pekerjaan_ibu == "Buruh")
                                            echo "selected"; ?>>Buruh</option>
                                        <option value="Pensiunan" <?php if ($pekerjaan_ibu == "Pensiunan")
                                            echo "selected"; ?>>Pensiunan</option>
                                        <option value="Lain-lain" <?php if ($pekerjaan_ibu == "Lain-lain")
                                            echo "selected"; ?>>Lain-lain</option>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <select name="penghasilan_ibu" class="form-control <?php echo ($error_penghasilan_ibu != "" ? "is-invalid" : ""); ?>" id="penghasilan_ibu">
                                        <option value="Kurang dari Rp. 500.000" <?php if ($penghasilan_ibu == "Kurang dari Rp. 500.000")
                                            echo "selected"; ?>>Kurang dari Rp. 500.000</option>
                                        <option value="Rp. 500.000 - Rp. 999.999" <?php if ($penghasilan_ibu == "Rp. 500.000 - Rp. 999.999")
                                            echo "selected"; ?>>Rp. 500.000 - Rp. 999.999</option>
                                        <option value="Rp. 1.000.000 - Rp. 1.999.999" <?php if ($penghasilan_ibu == "Rp. 1.000.000 - Rp. 1.999.999")
                                            echo "selected"; ?>>Rp. 1.000.000 - Rp. 1.999.999</option>
                                        <option value="Rp. 2.000.000 - Rp. 4.999.999" <?php if ($penghasilan_ibu == "Rp. 2.000.000 - Rp. 4.999.999")
                                            echo "selected"; ?>>Rp. 2.000.000 - Rp. 4.999.999</option>
                                        <option value="Rp. 5.000.000 - Rp. 19.999.999" <?php if ($penghasilan_ibu == "Rp. 5.000.000 - Rp. 19.999.999")
                                            echo "selected"; ?>>Rp. 5.000.000 - Rp. 19.999.999</option>
                                        <option value="Lebih dari Rp. 20.000.000" <?php if ($penghasilan_ibu == "Lebih dari Rp. 20.000.000")
                                            echo "selected"; ?>>Lebih dari Rp. 20.000.000</option>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <select name="berkebutuhan_khusus_ibu" class="form-control <?php echo ($error_berkebutuhan_khusus_ibu != "" ? "is-invalid" : ""); ?>" id="berkebutuhan_khusus_ibu">
                                        <option value="Tidak" <?php if ($berkebutuhan_khusus_ibu == "Tidak")
                                            echo "selected"; ?>>Tidak</option>
                                        <option value="Netra" <?php if ($berkebutuhan_khusus_ibu == "Netra")
                                            echo "selected"; ?>>Netra</option>
                                        <option value="Rungu" <?php if ($berkebutuhan_khusus_ibu == "Rungu")
                                            echo "selected"; ?>>Rungu</option>
                                        <option value="Grahita Ringan" <?php if ($berkebutuhan_khusus_ibu == "Grahita Ringan")
                                            echo "selected"; ?>>Grahita Ringan</option>
                                        <option value="Grahita Sedang" <?php if ($berkebutuhan_khusus_ibu == "Grahita Sedang")
                                            echo "selected"; ?>>Grahita Sedang</option>
                                        <option value="Daksa Ringan" <?php if ($berkebutuhan_khusus_ibu == "Daksa Ringan")
                                            echo "selected"; ?>>Daksa Ringan</option>
                                        <option value="Daksa Sedang" <?php if ($berkebutuhan_khusus_ibu == "Daksa Sedang")
                                            echo "selected"; ?>>Daksa Sedang</option>
                                        <option value="Laras" <?php if ($berkebutuhan_khusus_ibu == "Laras")
                                            echo "selected"; ?>>Laras</option>
                                        <option value="Wicara" <?php if ($berkebutuhan_khusus_ibu == "Wicara")
                                            echo "selected"; ?>>Wicara</option>
                                        <option value="Tuna Ganda" <?php if ($berkebutuhan_khusus_ibu == "Tuna Ganda")
                                            echo "selected"; ?>>Tuna Ganda</option>
                                        <option value="Hiper Aktif" <?php if ($berkebutuhan_khusus_ibu == "Hiper Aktif")
                                            echo "selected"; ?>>Hiper Aktif</option>
                                        <option value="Cerdas Istimewa" <?php if ($berkebutuhan_khusus_ibu == "Cerdas Istimewa")
                                            echo "selected"; ?>>Cerdas Istimewa</option>
                                        <option value="Bakat Istimewa" <?php if ($berkebutuhan_khusus_ibu == "Bakat Istimewa")
                                            echo "selected"; ?>>Bakat Istimewa</option>
                                        <option value="Kesulitan Belajar" <?php if ($berkebutuhan_khusus_ibu == "Kesulitan Belajar")
                                            echo "selected"; ?>>Kesulitan Belajar</option>
                                        <option value="Narkoba" <?php if ($berkebutuhan_khusus_ibu == "Narkoba")
                                            echo "selected"; ?>>Narkoba</option>
                                        <option value="Indigo" <?php if ($berkebutuhan_khusus_ibu == "Indigo")
                                            echo "selected"; ?>>Indigo</option>
                                        <option value="Down Sindrome" <?php if ($berkebutuhan_khusus_ibu == "Down Sindrome")
                                            echo "selected"; ?>>Down Sindrome</option>
                                        <option value="Autis" <?php if ($berkebutuhan_khusus_ibu == "Autis")
                                            echo "selected"; ?>>Autis</option>
                                    </select>
