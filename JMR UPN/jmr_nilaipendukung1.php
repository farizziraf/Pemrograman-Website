...
$sql_pengguna = "SELECT users.nama, j1.prodi AS program_studi1
                 FROM users
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  $sql_insert = "INSERT INTO jmr_nilaipendukung1 (id_pendaftaran, mata_pelajaran, kelas_10_smt1, kelas_10_smt2, kelas_11_smt1, kelas_11_smt2, kelas_12_smt1)
...
<div class="menu_container">
  ...
  <div class="content">
  <p class="judul">Entry Rata-rata Nilai Mata Pelajaran Pendukung Pilihan 1</p>
  <form method="post" action="" onsubmit="return confirmSubmit()">
    ...
    <br>
    <label for="program_studi1">Pilihan Program Studi 1:</label>
